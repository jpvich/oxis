...
use oxis_core::{EuropeanOption, MarketData, OptionType, OxisError, mean_and_se, normal_cdf};
use oxis_stochastic::{Process, SimConfig, simulate_paths};

use crate::McEstimate;
...
mod tests {
    ...
    fn geometric_asian_is_cheaper_than_vanilla() {
        ...
        let vanilla = crate::black_scholes(&o, &m).unwrap();
        assert!(

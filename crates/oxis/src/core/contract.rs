...
//!    `fn price(option: &EuropeanOption, market: &MarketData) -> crate::core::Result<PriceResult>`.
...
//!    [`Tabular`](crate::core::output::Tabular). The core renders human / JSON / TSV;
...
//!    shared contract — see [`DataSource`](crate::core::source::DataSource) — so
//!    consumers depend on the capability, not the concrete provider.
//! 2. **A concrete service type** constructed from a [`RunContext`](crate::core::context::RunContext),
...
//!    [`crate::core::series`] (or implement [`Tabular`](crate::core::output::Tabular) for CLI

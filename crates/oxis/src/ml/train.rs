...
use crate::ml::activation::{softplus_prime, softplus_second};
use crate::ml::data::{BsSpec, generate_european};
use crate::ml::mlp::{Mlp, matvec, matvec_t};
use crate::ml::optim::{Adam, Grad, accum_outer, mean_std, one_cycle_lr};
    ...
    fn default() -> Self {
        Self {
            spec: BsSpec {
                ...
                vol: 0.2,
                maturity: 1.0,
                option_type: crate::core::OptionType::Call,
            },
            n_samples: 8192,
            hidden: vec![32, 32],
            epochs: 100,
...
mod tests {
    ...
    fn calibrate_grid_accuracy() {
        use crate::ml::result::black_scholes_price_delta;
        let cfg = TrainConfig {
            spec: spec(),
            n_samples: 4096,
            hidden: vec![30, 30],

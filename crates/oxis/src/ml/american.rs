...
//!
//! Both neural engines ([`crate::ml::deep_lsm`], [`crate::ml::dos`]) price a 1-D American
...
use crate::core::{MarketData, OptionType, OxisError, path_seed};
...
///
/// Mirrors `crate::pricing::monte_carlo::validate_inputs` (which is crate-private)

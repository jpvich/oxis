...
//! immediate-exercise check — matches `crate::pricing::lsm_american`, so the price
//! is a low-biased estimate directly comparable to the classical engine and the
//! QuantLib-validated binomial tree.

use crate::core::{MarketData, OptionType, OxisError, mean_and_se, path_seed};
...
mod tests {
    ...
    use crate::pricing::{binomial, lsm_american};

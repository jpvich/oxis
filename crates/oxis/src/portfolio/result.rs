...
use crate::portfolio::risk::{
    annualized_volatility, covariance_matrix, portfolio_returns, portfolio_variance,
};
use crate::portfolio::valuation::{HoldingValuation, HoldingsValuation};
use crate::stats::{historical_var, parametric_var};
use serde::Serialize;
...
pub fn optimization_report(
    ...
    let (expected_return, variance, volatility) =
        crate::portfolio::optimize::frontier_stats(&weights, mean, cov)?;

...
//! value backprop.
//!
//! These were factored out of the differential-ML trainer ([`crate::train`]) so
//! the American engines ([`crate::deep_lsm`], [`crate::dos`]) can reuse exactly
...
use crate::activation::softplus_prime;
use crate::mlp::{Forward, Mlp, matvec_t, outer};
